...
$query = "SELECT id, username, email, first_name, last_name, address, state, phone, creatorid, stateid FROM teachers";
...
<h3>All Teachers</h3>
    ...
    <tr>
      ...
      <th>School ID</th><th>User Name</th><th>Email</th><th>First Name</th><th>Last Name</th><th>Address</th> <th>State</th> <th>Phone</th>  <th>Creator's Unique ID</th><th>Teacher's State ID</th>
    </tr>

...
$query = "SELECT id, username, email, schoolname, schoolid, first_name, last_name, address, state, phone, creatorid, creatorusername, stateid FROM students";
...
<h3>All Teachers</h3>
    ...
    <tr>
      ...
      <th>School ID</th><th>User Name</th><th>Email</th><th>School ID</th> <th></th> School Name<th>First Name</th><th>Last Name</th><th>Address</th> <th>State</th> <th>Phone</th>  <th>Creator's Unique ID</th><th>Creator User Name</th><th>Student's State ID</th>
    </tr>
...
while ($row= mysqli_fetch_assoc($school_result)) {
 ...
 echo "<td>" . $row['creatorid'] . "</td>";
  echo "<td>" . $row['creatorusername'] . "</td>";

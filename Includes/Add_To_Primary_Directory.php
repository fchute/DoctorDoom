<?php
    ...
    $query = "INSERT INTO list(username,password,first_name,last_name,address,state,phone) ";
    $query .= "VALUE ('$username', '$password', '$first_name', '$last_name', '$address', '$state', '$phone')";
    ...
    if (!$result) {
      # code...
    die("Query dFAILED" . mysqli_error($connection)) ;
  }

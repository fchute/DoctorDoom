...
<div class="" style="   float:left; display:inline;">
  ...
  <div class="col-sm-12">
    <div class="" style="   float:left; display:inline;">
      ...
      <a href="Teacher_List.php" class="btn btn-primary btn-md active" role="button" style="margin:10px;">All Teachers</a>
    </div>


    <div class="" style="   float:left; display:inline;">

      <a href="Student_List.php" class="btn btn-primary btn-md active" role="button" style="margin:10px;">All Students</a>
    </div>
...
<h3>Your Profile Information</h3>
    ...
    <tr>
      ...
      <th>User ID</th><th>State ID</th> <th>Username</th> <th>email</th>
...
?>
  ...
  <h3>Your Students</h3>
      ...
      <tr>
        ...
        <th>Student ID</th><th>State ID</th> <th>Username</th> <th>email</th>
        <th>First Name</th><th>Last Name</th>
        <th>Address</th><th>State</th><th>Phone</th><th>School Name</th><th>School ID</th>
      </tr>
